...
def negativo():
    numero = int(input("Agora, insira um número negativo: "))
    if numero < 0:
        abs(numero)
    else:
        print("Seu número não é negativo. Tente novamente!")
        return negativo()
...
maior_valor2 = pegar_maior_valor(n1, n2, n3, n4, n5, n6)
print("O maior número é {}.".format(maior_valor2))
menor_valor2 = pegar_menor_valor(n1, n2, n3, n4, n5, n6)
print("O maior número é {}.".format(maior_valor2))

# TERMINAR EXERCÍCIO 18. ITEM 3 EM DIANTE
